	...
	<div id="rsvContainer">
		...
		<c:if test="${isRsv==true }">
			<div id="rsvGuide" class="success">
				<h1 id="result">예약 성공!</h1>
				<h1 class="result2"><span><fmt:formatDate value="${rsv.rsvTime}" pattern="yyyy-MM-dd kk:mm"/></span>일에 예약 되었습니다.</h1>
				<p>&nbsp;</p>
		...
		<div id="rsvGuide" class="fail">
			<h1  id="result">예약 실패</h1>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<h1  class="result2"><span><fmt:formatDate value="${rsv.rsvTime}" pattern="yyyy-MM-dd kk:mm"/></span>일 해당 좌석에 예약이 있습니다.</h1>
			<h1 id="other"  class="result2">다른 좌석을 선택하세요.</h1>
			<p id="link"><a href="${pageContext.request.contextPath}"><img src="images/go_main.gif"></a></p>
		</div>
		</c:if>
		</div>
