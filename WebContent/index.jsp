...
<script>
	...
	<div id="middleContainer">
		<div id="middleTop">
			...
			<div id="middleTopCenter" class="middleTop1">
				<div id="salad">
					<div>
						<img src="${pageContext.request.contextPath}/images/main/s_b2_img1.png">
					</div>
					<div>
						<img src="${pageContext.request.contextPath}/images/main/s_b2_img1.png">
					</div>
					<div>
						<img src="${pageContext.request.contextPath}/images/main/s_b2_img2.png">
					</div>
					<div>
						<img src="${pageContext.request.contextPath}/images/main/s_b2_img3.png">
					</div>
					<div>
						<img src="${pageContext.request.contextPath}/images/main/s_b2_img4.png">
					</div>
					<div>
						<img src="${pageContext.request.contextPath}/images/main/s_b2_img5.png">
					</div>
				</div>
			</div>
		...
		<div id="middleBottom">
			<div class="middleBottom1">
				<p>
					<img src="${pageContext.request.contextPath}/images/main/middleImg1.jpg">
				</p>
				<dl>
					<dt>라라코스트 PUB FOOD 4종 출시!</dt>
					<dd>2019.06.17 ~ 소진시</dd>
				</dl>
				<p class="text">라라코스트 PUB FOOD 4종 출시!</p>
			</div>
			<div class="middleBottom1">
				<p>
					<img src="${pageContext.request.contextPath}/images/main/middleImg2.jpg">
				</p>
				<dl>
					<dt>라라코스트 여름 시즌 샐러드 파스타 3종 출시</dt>
					<dd>2019.05.13 ~ 소진시</dd>
				</dl>
				<p class="text">라라코스트 여름 시즌 샐러드 파스타 3종 출시</p>
			</div>
			<div class="middleBottom1">
				<p>
					<img src="${pageContext.request.contextPath}/images/main/middleImg3.jpg">
				</p>
				<dl>
					<dt>[충남공주점] 메가박스 제휴이벤트</dt>
					<dd>2018-11-05 ~ 2019-10-31</dd>
				</dl>
				<p class="text">영수증 지참 시 콤보 할인 등</p>
			</div>
			<div class="middleBottom1">
				<p>
					<img src="${pageContext.request.contextPath}/images/main/middleImg4.png">
				</p>
				<dl>
					<dt>&nbsp;</dt>
					<dd>&nbsp;</dd>
	...
	<div id="bottomContainer">
		<div id="news">
			...
			<p id="tp">라라코스트 부천중동점 식약처 위생···</p>
			<p>라라코스트 전국 어린이 공모전 수상자···</p>
			<p>[포항문덕점]6월 25일(화)~6월26일(수)···</p>
			<p id="btm">라라코스트 PUB FOOD 4종 출시!</p>
